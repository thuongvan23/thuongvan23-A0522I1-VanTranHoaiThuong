    ...
    <div class="main-content" id="form-create">
        ...
        <form class="row g-3" action="/MainServlet" method="post">
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="inputEmail4" name="id" placeholder="${student.id}">
            </div>
            <div class="col-md-6">
                <label for="inputPassword4" class="form-label">Full Name</label>
                <input type="text" class="form-control" id="inputPassword4" name="name" placeholder="${student.name}">
            </div>
            <div class="col-12">
                <label for="inputAddress" class="form-label">Day of birth</label>
                <input name="birthday" type="text" class="form-control" id="inputAddress" placeholder="yyyy-MM-dd" style="width: 50%" placeholder="${student.birthday}">
            </div>
            <div class="col-12">
                <label for="inputAddress2" class="form-label">Age</label>
                <input name="age" type="text" class="form-control" id="inputAddress2" style="width: 50%" placeholder="${student.age}">
            </div>
            <div class="col-md-4">
                <label for="inputState" class="form-label">Student Type</label>
                <select name="studentTypeId" id="inputState" class="form-select" placeholder="${studentType}">
