    ...
    <table class="table table-hover">
        ...
        <c:forEach items="${houses}" var="house">
            <tr>
                ...
                <td>${house.note}</td>
                <td style="width: 94px"><button type="button" class="btn btn-secondary"><a style="text-decoration: none; color: white" href="MainServlet?action=delete&id=${house.id}">Delete</a></button></td>
            </tr>
        </c:forEach>
        </tbody>
    </table>
