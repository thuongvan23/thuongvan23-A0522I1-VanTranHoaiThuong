  ...
  <div class="main-content" id="form-create">
    ...
    <form class="row g-3" action="/MainServlet" method="post">
      ...
      <div class="col-12">
        ...
        <input name="phoneNumber" type="text" class="form-control" id="inputAddress2" style="width: 50%">
      </div>

      <div class="col-12">
        <label for="inputAddress" class="form-label">Date start</label>
        <input name="dateStart" type="date" class="form-control" id="inputAddress" placeholder="yyyy-MM-dd" style="width: 50%">
      </div>


      <div class="col-md-4">
        <label for="inputState" class="form-label">Payment</label>
        <select name="paymentId" id="inputState" class="form-select">
          <option selected>Choose...</option>
          <option value="1">Per Month</option>
          <option value="2">Per 3 Month</option>
          <option value="3">Per Year</option>
        </select>
      </div>
      <div class="col-12">
        <label for="inputAddress2" class="form-label">Note</label>
        <input name="note" type="text" class="form-control" style="width: 50%">
      </div>
