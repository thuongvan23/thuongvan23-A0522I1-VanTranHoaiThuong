  ...
  <div class="main-content" id="form-create">
    ...
    <form class="row g-3" action="/MainServlet" method="post">
      <div class="col-md-6">
        ...
        <input type="text" class="form-control" id="inputPassword4" placeholder="${benhNhan.ten}" name="ten_benh_nhan">
      </div>
      <div class="col-12">
      ...
      <div class="col-12">
        ...
        <input placeholder="${benhNhan.li_do_nhap_vien}" name="li_do_nhap_vien" type="text" class="form-control" id="inputAddress2" style="width: 50%">
      </div>

      <div class="col-12" style="margin-top: 20px">
        <button type="submit" class="btn btn-primary">Update</button>
      </div>
      <input type="hidden" name="idUpdate" value="${benhNhan.ma_benh_nhan}">
