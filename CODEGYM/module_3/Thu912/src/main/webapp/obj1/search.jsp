...
<div id="main">
  ...
  <table class="table table-hover">
    ...
    <tr>
      ...
      <td style="width: 94px"><button type="button" class="btn btn-secondary"><a style="text-decoration: none; color: black" href="MainServlet?action=update&id=${benhNhan.ma_benh_nhan}">Update</a></button></td>
      <td style="width: 94px"><button type="button" class="btn btn-secondary"><a style="text-decoration: none; color: black" href="MainServlet?action=delete&id=${benhNhan.ma_benh_nhan}">Delete</a></button></td>
    </tr>
    </tbody>
  </table>
</div>
