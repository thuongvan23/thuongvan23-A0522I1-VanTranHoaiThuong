...
<div id="main">
  ...
  <table class="table table-hover">
    ...
    <th scope="col">Date start rent</th>
    ...
    <tr>
      <%--                <th scope="row">1</th>--%>
        ...
        <td>${house.dateStart}</td>
        <td>${house.payment.howToPay}</td>
        <td>${house.note}</td>
      <td style="width: 94px"><button type="button" class="btn btn-secondary"><a style="text-decoration: none; color: black" href="MainServlet?action=delete&id=${house.id}">Delete</a></button></td>
    </tr>
    </tbody>
  </table>
</div>
